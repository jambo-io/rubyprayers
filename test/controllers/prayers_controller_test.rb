...
class PrayersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prayer" do
    assert_difference('Prayer.count') do
      post prayers_url, params: { prayer: { author: @prayer.author, prayer: @prayer.prayer } }
    end
  ...
  test "should update prayer" do
    patch prayer_url(@prayer), params: { prayer: { author: @prayer.author, prayer: @prayer.prayer } }
